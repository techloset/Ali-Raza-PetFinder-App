...
import { GetOrganization, organization } from "../../../redux/OrganizationSlice";
    ...
    <>
      <div className="">
        <div className="h-[810px] bg-slate-200 ">
          <div className="h-[486px] xx:h-[340px] w-auto flex justify-center bg-black">
            <img src={petDetail?.photos?.[0]?.full || alternative} alt="dog image" className="h-full" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-10 gap-8 w-full max-w-5xl mx-auto xx:px-0 px-4 md:px-0 relative bottom-72 xx:bottom-96 sm:bottom-56 md:bottom-68 lg:bottom-72 xX:justify-evenly">
          <div className="col-span-full lg:col-span-6 bg-white xx:p-0 p-8 xx:rounded-none rounded-xl shadow-lg mb-8  md:mb-0 ">
            <div className="">
              ...
              <div className="flex text-base px-7 py-2 xx:justify-center sm:justify-center sm:inline-flex">
                <Link to="" className="underline text-blue-700">
                  {petDetail?.breeds?.primary || petDetail?.breeds?.secondary || "Breed not defined"}
                </Link>
                <div className="px-1">.</div>
                <div className="">{petDetail?.contact?.address?.city || petDetail?.contact?.address.address2 || "Address is not defined"} {petDetail?.contact?.address?.state}</div>
              </div>
            </div>
            ...
            <div className="flex text-base gap-4 mt-3 h-[35px] sm:hidden md:hidden lg:hidden">
              <div className="hover:border-b-2 border-indigo-500  flex justify-center w-16">About</div>
              <div className="hover:border-b-2 border-indigo-500 ">Organization</div>
          ...
          <div className=" max-w-[393px] md:max-h-[463px] max-h-[463px] mx-auto md:sm-auto xx:mx-auto lg:max-h-[390px] sm:flex sm:content-center pb-0 col-span-full  lg:col-span-4  text-white p-8 rounded-xl shadow-lg mb-8 md:mb-0 bg-purp">
            <div className=" pb-0 mb-0">
              <div className="text-xl font-normal max-mt-6 text-center flex flex-wrap">Considering {petDetail?.name} for adoption?</div>
              <div className="rounded-3xl  text-center mt-10 bg-white border-2 text-purp hover:bg-purp hover:text-white hover:border-2 hover:bordre-white"><button type="button" className="h-[45PX] text-sm font-normal  ">START YOUR INQUIRY</button></div>
              <div className="flex items-center justify-center rounded-3xl h-[45PX] text-center mt-10 border-2 border-white hover:bg-white hover:text-purp">READ FAQs</div>
              ...
              <div className="h-[65px]  flex justify-around items-center sticky">
                ...
                <div className="flex xx:gap-1 md:gap-2 justify-center "><img src={FaviorteHeart} alt="" />FAVORITE</div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[393px] border-2 col-span-full md:mx-auto sm:mx-auto xx:mx-auto lg:col-start-7 lg:col-span-4 bg-white p-8 rounded-2xl shadow-lg  md:mb-0 relative  lg:bottom-20 lg:top-[-80px]  xx:top-8 sm:top-8 md:top-16 pb-0">
            <div className="flex bg-purp  justify-center items-center relative bottom-20 h-[100px] w-[100px] rounded-full mx-auto"><img src={PawHand} alt="" className="h-[60px] w-[58px]" /></div>
            <div className=" relative bottom-16">
              <div className="text-3xl text-center">{petDetail?.organization_id} Animals In Need</div>
              <div className="text-center">{petDetail?.contact?.address.city || petDetail?.contact?.address.address2 || "Address is not defined"} {petDetail?.contact?.address.state}</div>
              <div className="mt-12 flex items-center pb-4 border-b-[1px] border-slate-400">
                <div className="relative left-[-10px]"><img src={LocationIcon} alt="Location" /></div>
                <div className="">
              ...
              <div className="mt-8 flex items-center pb-5 border-b-[1px] border-slate-400">
                <div className="relative left-[-10px]"><img src={PhoneIcon} alt="PhoneIcon" /></div>
                <div className="">
                  <div className="flex gap-3">{petDetail?.contact?.phone || petDetail?.contact?.email || "No phone number given"}</div>
                  {/* <hr className=" mt-4 border-1 border-black " /> */}
                </div>
              </div>
              <div className="flex items-center justify-center rounded-3xl h-[45PX] text-center mt-10 border-2 border-black hover:bg-purp hover:text-white hover:border-2 hover:border-white hover:shadow-xl"><button type="button">MORE ABOUT US</button></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="h-[327px] flex justify-center items-center flex-col text-white bg-purp relative bottom-72 xx:hidden sm:hidden md:hidden lg:flex">
        <div className="mx-[60px]  ">
          <div className="flex mx-10 items-center gap-5  ">
            <div className="w-[103px] h-[103px] flex items-center"><img src={petDetail?.photos?.[0]?.small || alternative} alt="dog Image" className="rounded-full border-4 border-white w-full h-full" /></div>
            <div className="">
              <div className="text-3xl ">Ask About {petDetail?.name}</div>
              <div className="mt-2 mb-2">{petDetail?.breeds?.primary || petDetail?.breeds?.secondary || "Breed not defined"}</div>
              <div className="flex text-base xx:justify-center  sm:inline-flex">
                <div className="">{petDetail?.gender || "no gender"}</div>
                <div className="px-2">.</div>
          ...
          <div className=" mx-10 ">
            <div className="my-2">Please note that {petDetail?.name} Animals In Need is not able to answer inquiries via email through Petfinder at this time.</div>
            <div className="flex gap-8 my-2">
              <div className="">You may call them with your inquiry at: </div>
              <div className="hover:underline">{petDetail?.contact?.phone || petDetail?.contact?.email || "Phone Number not Given"}</div>
            </div>
            <div className="flex gap-10 my-2">
              <div className="">You may also find more information about the organization on their homepage: </div>
              <Link to={petDetail?.url || '/default-url'}><div className="hover:underline">{petDetail?.url.slice(0, 50)}</div></Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-violet-800 pt-8 sm:mt-40 relative sm:bottom-72 xx:bottom-72 lg:bottom-[450px]">
        ...
        <div className="flex flex-wrap justify-center text-center">
          ...
          {organization && organization.slice(17, 20).map((item: organization, i: number) => {
                    ...
                    <div className=" top-[-10px] h-[70px] bg-white text-purp block">
                      ...
                      <div className="h-8 bg-white">
                        ...
                        <div className="inline-flex h-14">
                          {item?.description?.slice(0, 50) || "Description is not Avilable"}
                        </div>
                        <hr className="border border-slate-200 w-full my-5 " />
                        <div className="   inline-flex ">
                          <Link to={`/details/${item.id}`} type="button" className="bg-white w-full">Read More</Link>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <div className="flex flex-wrap justify-center text-center relative sm:bottom-90 xx:bottom-80 md:bottom-60 gap-5 lg:bottom-[450px] lg:mb-[-430px] pb-0">
        {organization && organization.slice(11, 15).map((item: organization, i: number) => {
